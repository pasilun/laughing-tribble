...
export default function Home() {
  ...
  const greetingColor = isRed ? 'text-red-600 dark:text-red-400' : 'text-black dark:text-zinc-50'
    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        <div className="flex flex-col items-center gap-8 text-center sm:items-start sm:text-left w-full">
          <h1 className={`text-4xl font-semibold leading-10 tracking-tight ${greetingColor}`}>
            {greeting}
          </h1>
          <Link
            href="/design"
          ...
          <button
            ...
            aria-label="Byt färg på hälsning"
          >
            Byt färg
          </button>
